<!--=================================
@php
    $guard = auth('student')->check()? 'student': (auth('teacher')->check()? 'teacher': (auth('parent')->check()? 'parent': 'web'));
@endphp
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <form method="post" action="{{ route('logout', $guard) }}">
                    @csrf
                    @method('post')
                    <input type="submit" value="تسجيل الخروج" class="dropdown-item">
